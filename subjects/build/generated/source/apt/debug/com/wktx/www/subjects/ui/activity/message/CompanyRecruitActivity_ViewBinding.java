...
public class CompanyRecruitActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public CompanyRecruitActivity_ViewBinding(CompanyRecruitActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CompanyRecruitActivity_ViewBinding(final CompanyRecruitActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CompanyRecruitActivity target = this.target;
