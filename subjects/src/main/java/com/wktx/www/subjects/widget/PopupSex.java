...
public class PopupSex extends PopupWindow implements OnClickListener {
    public Context mContext;
    public Activity mActivity;

    private TextView tvMan, tvWomen, mCancel;

    public PopupSex(Context context, Activity mActivity) {
        initView(context);
    ...
    private void initView(Context mContext) {
        ...
        View v = LayoutInflater.from(mContext).inflate(R.layout.widget_popup_sex, null);
        setContentView(v);
