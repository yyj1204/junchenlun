...
import com.wktx.www.subjects.presenter.message.CompanyRecruitPresenter;
import com.wktx.www.subjects.ui.activity.main.PositionDetailsActivity;
import com.wktx.www.subjects.ui.adapter.message.CompanyRecruitAdapter;
 ...
 * 对我感兴趣公司-公司招聘列表
 */
public class CompanyRecruitActivity extends ABaseActivity<IView,CompanyRecruitPresenter> implements IView<List<RecruitListInfoData>> {
    public static CompanyRecruitActivity instance = null;
    ...
    private CompanyRecruitAdapter mAdapter;//RecyclerView 适配器
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 设置右滑动返回
        Slidr.attach(this);
        tvTitle.setText(R.string.title_company_recruit);
        initData();
        initRecycleView();
        initAdapter();
        initRefreshLayout();
    ...
    /**
     * 接收 PositionDetailsActivity Message2InterestedFragment 传递过来的公司id
     */
    ...
    private void initRecycleView() {
        ...
        //设置分割线与垂直方向布局
        recyclerView.addItemDecoration(MyUtils.drawDivider(CompanyRecruitActivity.this, LinearLayout.VERTICAL, R.drawable.divider_f0f0f0_14));
        MyLayoutManager manager = new MyLayoutManager(CompanyRecruitActivity.this, LinearLayout.VERTICAL, false);
    ...
    private void initAdapter() {
        mAdapter = new CompanyRecruitAdapter(CompanyRecruitActivity.this);
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                //打开招聘详情界面（传递招聘需求id）
                Intent intent = new Intent(CompanyRecruitActivity.this, PositionDetailsActivity.class);
