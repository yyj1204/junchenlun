 ...
 * 管理我的工作---我的工资
 */
public class ManageSalaryActivity extends ABaseActivity<IView,SalaryPresenter> implements IView<SalaryInfoData> {
    ...
    private void initAdapter() {
        mAdapter = new BaseQuickAdapter<SalaryPayBean, BaseViewHolder>(R.layout.item_rv_tradingrecord, null) {
            @Override
