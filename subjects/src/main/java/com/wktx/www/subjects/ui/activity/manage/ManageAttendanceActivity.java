 ...
 * 管理我的工作---签到
 */
public class ManageAttendanceActivity extends ABaseActivity<IAttendanceView,AttendancePresenter> implements IAttendanceView,CustomCalendar.CustomCalendarListener{
