package com.wktx.www.subjects.Adapter;
    ...
    private void fillValue(int position, ViewHolder viewHolder) {
        ...
        if (checkItemPosition != -1) {
            if (checkItemPosition == position) {
                ...
                viewHolder.mText.setTextColor(context.getResources().getColor(R.color.title_color));
                viewHolder.mText.setBackgroundResource(R.color.main_white);
            }
        }
    }
