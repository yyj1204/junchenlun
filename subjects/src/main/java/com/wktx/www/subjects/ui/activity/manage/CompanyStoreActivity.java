...
import com.wktx.www.subjects.presenter.manage.CompanyStorePresenter;
import com.wktx.www.subjects.ui.adapter.manage.StoreListAdapter;
 ...
 *工作管理 --- 公司店铺列表
 */
public class CompanyStoreActivity extends ABaseActivity<IView,CompanyStorePresenter> implements IView<List<StoreListInfoData>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 设置右滑动返回
        Slidr.attach(this);
        tvTitle.setText(R.string.title_company_storelist);
        initData();
        initRecycleView();
        initAdapter();
        initRefreshLayout();
    ...
    @Override
    protected CompanyStorePresenter createPresenter() {
        return new CompanyStorePresenter();
    }

    /**
     * 接收 ManageKPIActivity 传递过来的公司id
     */
