 ...
 * 消息---互动---邀请面试
 */
public class Message2InterviewFragment extends Fragment {
    ...
    public Message2InterviewFragment() {
    }
    ...
    private void initUI() {
        ...
        mAdapter = new BaseQuickAdapter<String, BaseViewHolder>(R.layout.item_rv_message2interview, stringList) {
            @Override
