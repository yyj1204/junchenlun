 ...
 * 管理我的工作---报告(工作安排列表)
 */
public class ManageReportActivity extends AutoLayoutActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 设置右滑动返回
        Slidr.attach(this);
        tvTitle.setText(R.string.title_manage_report);
        initData();
        initRecycleView();
        initAdapter();
    }
    ...
    private void initAdapter() {
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                //将安排工作id 传递给工作报告列表
                Intent intent = new Intent(ManageReportActivity.this, ReportListActivity.class);
