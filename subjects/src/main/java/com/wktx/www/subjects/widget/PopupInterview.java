...
public class PopupInterview extends PopupWindow implements OnClickListener {
    ...
    private LinearLayout llPhone, llQQ, llWechat,llResume;
    ...
    private void initView(Context mContext) {
        ...
        llResume = (LinearLayout) v.findViewById(R.id.linear_resume);
    ...
    public void onClick(View arg0) {
        switch (arg0.getId()) {
            ...
            case R.id.linear_resume:
                if (listener != null) {
                    listener.getInterviewWay(ConstantUtil.InterviewWay.RESUME);
                }
                this.dismiss();
                break;
            case R.id.tv_cancel:
