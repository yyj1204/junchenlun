...
public class EditLoginPwdPresenter extends ABasePresenter<IForgetPwdView> {


    public EditLoginPwdPresenter() {
    }
    ...
    public void onEditPwd(){
        ...
        LogUtil.error("修改登录密码","json==="+httpParams.toString());
                ...
                .execute(new CallBackProxy<CustomApiResult<CommonSimpleData>, CommonSimpleData>
                        (new ProgressDialogCallBack<CommonSimpleData>(mProgressDialog) {
                            ...
                            public void onError(ApiException e) {
                                super.onError(e);
                                LogUtil.error("修改登录密码","e=="+e.getMessage());
                            ...
                            public void onSuccess(CommonSimpleData result) {
                                if (result != null) {
                                    LogUtil.error("修改登录密码","result=="+result.toString());

                                    if (result.getCode()==0){//修改登录密码 成功
