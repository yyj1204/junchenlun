 ...
 */
public class PopupInterview extends PopupWindow implements OnClickListener {
    public Context mContext;
    public Activity mActivity;

    private LinearLayout llPhone, llQQ, llWechat,linearInterview;
    private TextView tvCancel;

    public PopupInterview(Context context, Activity mActivity) {
        initView(context);
    ...
    private void initView(Context mContext) {
        ...
        View v = LayoutInflater.from(mContext).inflate(R.layout.widget_popup_interview, null);
        setContentView(v);
        ...
        linearInterview = (LinearLayout) v.findViewById(R.id.linear_interview);
        tvCancel = (TextView) v.findViewById(R.id.tv_cancel);
        llPhone.setOnClickListener(this);
        llQQ.setOnClickListener(this);
        llWechat.setOnClickListener(this);
        linearInterview.setOnClickListener(this);
    ...
    public void onClick(View arg0) {
        switch (arg0.getId()) {
            ...
            case R.id.linear_wechat:
                ...
                this.dismiss();
                break;
            case R.id.linear_interview:
                if (listener != null) {
                    listener.getInterviewWay(ConstantUtil.InterviewWay.INTERVIEW);
                }
                this.dismiss();
                break;
            case R.id.tv_cancel:
