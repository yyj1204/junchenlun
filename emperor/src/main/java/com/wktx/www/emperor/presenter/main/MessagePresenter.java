...
import com.wktx.www.emperor.apiresult.main.message.MessageData;
...
public class MessagePresenter extends ABasePresenter<IView> {
    ...
    public void onMessageList(String type){
        ...
        EasyHttp.post(ApiURL.COMMON_URL)
                ...
                .params(httpParams)
                .execute(new CallBackProxy<CustomApiResult<MessageData>, MessageData>
                        (new SimpleCallBack<MessageData>() {
                            @Override
