...
public class AuthentStoreData {
    private int code;
    private String msg;
    private AuthentStoreInfoData info;
    ...
    public AuthentStoreInfoData getInfo() {
        return info;
    }

    public void setInfo(AuthentStoreInfoData info) {
        this.info = info;
    }
