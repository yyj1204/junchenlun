 ...
 * 退出登录弹窗
 */
public class LogoutPopup extends PopupWindow implements OnClickListener {

    public Context mContext;
    public Activity mActivity;
    private TextView mTvSure, mTvCancel;

    public LogoutPopup(Context context, Activity mActivity) {
        initView(context);
    ...
    private void initView(Context mContext) {
        ...
        View v = LayoutInflater.from(mContext).inflate(R.layout.widget_logout_popup, null);
        setContentView(v);
    ...
    public void onClick(View arg0) {
        switch (arg0.getId()) {
            case R.id.outTvSure:
                ...
                if (listener != null) {
                    listener.getText(ConstantUtil.LOGOUT);
                }
                this.dismiss();
                break;
