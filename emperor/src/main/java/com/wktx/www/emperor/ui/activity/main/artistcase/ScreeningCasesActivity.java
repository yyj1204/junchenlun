 ...
 * 案例---筛选界面（最多浏览、最多喜欢）
 */
public class ScreeningCasesActivity extends AutoLayoutActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screening_cases);
        //沉浸式状态栏
        StatusBarUtil.setColor(ScreeningCasesActivity.this, getResources().getColor(R.color.color_ffb321),0);
        //强制竖屏
    ...
    /**
     *接收 CasesActivity 传递过来的筛选条件（最多浏览、最多喜欢）
     */
    ...
    private void initFlowLayout() {
        ...
        //根据 CasesActivity 传过来的数据，给tag预先设置选中状态
