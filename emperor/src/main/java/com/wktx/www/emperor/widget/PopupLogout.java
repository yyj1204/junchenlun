 ...
 * 退出登录弹窗
 */
public class PopupLogout extends PopupWindow implements OnClickListener {

    public Context mContext;
    public Activity mActivity;
    private TextView mTvSure, mTvCancel;

    public PopupLogout(Context context, Activity mActivity) {
        initView(context);
    ...
    private void initView(Context mContext) {
        ...
        View v = LayoutInflater.from(mContext).inflate(R.layout.widget_popup_logout, null);
        setContentView(v);
